...
义各个周期的deadline, 在deadline之前, 一定完成某个 runtime。但是需要满足, 比例分
配算法，比例分配算法可以决定什么? 决定分配份额！也就是 runtime. 好，那我们就在
deadline 到达之前完成其比例份额的时间片!
...
> 了公平性。
>
> **所以, 我们必须采用其他的机制来打断其连续的发起event，并且在合适的时机在允许
> 其发起**
{: .prompt-tip}
